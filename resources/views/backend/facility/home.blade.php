      ...
      <div class="col-12">
        <div class="card">
            <div class="card-header">
              <a href="{{ url('backend/facility/create') }}"><i class="fas fa-plus"></i> Add</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($facilities as $facility)
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('backend/facility/'.$facility->id) }}" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                        <a href="{{ url('backend/facility/'.$facility->id.'/edit') }}" class="btn btn-xs btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
                        <form action="{{ url('backend/facility/'.$facility->id) }}" method="post" class=" d-inline">
                          @csrf
                          @method('delete')
